...
def main() -> None:
    ...
    beta_table = args.beta_table or Path(glm_config.get("beta_table", "results/first_level_betas.csv"))
    contrast_table = args.contrast_table or Path(
        glm_config.get("contrast_table", "results/first_level_contrasts.csv")
    )
    summary_table = args.summary_table or Path(
        glm_config.get("summary_table", "results/first_level_glm_summary.csv")
    )
